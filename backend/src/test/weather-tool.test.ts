...
describe.skip('Weather Tool', () => {
  beforeAll(() => {
    // Reset all mocks before each test
    vi.clearAllMocks();
  });

  it.skip('should have correct tool configuration', () => {
  ...
  it.skip('should validate zipCode parameter', () => {
    // expect(weatherTool.inputSchema).toBeDefined();
  ...
  it.skip('should handle valid zip code format', async () => {
  ...
  it.skip('should handle invalid zip code', async () => {
    // await expect(async () => {
  ...
  it.skip('should include proper User-Agent header', async () => {
    const mockResponse = {
      ok: true,
      json: async () => ({
        properties: {
