...
/**
 * Main Analytics Chat component for Mux video streaming insights
 * 
  ...
  useEffect(() => {
    ...
    const loadAgent = async () => {
      try {
        ...
        setAgentError(`Failed to load analytics agent: ${errorMessage}`)
        setAgent(null)
      }
    }
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm" style={{ color: 'var(--fg-subtle)' }}>
          AI-powered video streaming analytics and optimization recommendations from a video engineering perspective.
        </p>
      </div>
          ...
          {messages.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: 'var(--fg)' }}>
                Welcome to Mux Analytics Agent
              </h3>
              <p className="text-sm mb-4" style={{ color: 'var(--fg-subtle)' }}>
                AI-powered video streaming analytics and recommendations. Ask anything about your Mux data below.
              </p>
              <div className="rounded-lg p-4 mb-4" style={{ 
                ...
                <ul className="text-xs space-y-1 text-left" style={{ color: 'var(--fg-subtle)' }}>
                  <li>• "Analyze my streaming performance"</li>
                  <li>• "Generate an audio report of my analytics"</li>
                  <li>• "List my video assets"</li>
                  <li>• "What can I do to reduce errors?"</li>
                  <li>• "Show metrics from the last 7 days"</li>
                </ul>
              </div>
            </div>
          ) : (
      ...
      <div className="flex gap-2">
        <div className="flex-1">
          <input
            ...
            aria-label="Ask about Mux video analytics"
            autoComplete="off"
            className="input w-full"
            placeholder="Ask about video streaming analytics..."
            type="text"
            value={input}
      ...
      <div className="text-xs" style={{ color: 'var(--fg-subtle)' }}>
        Connected to agent: <code style={{ color: 'var(--fg)' }}>mux-analytics</code> at{' '}
